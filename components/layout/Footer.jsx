        ...
        <div className="max-w-[88rem] mx-auto px-4 md:px-12">
          <div className="flex flex-col md:flex-row md:justify-between gap-8 md:gap-0 md:h-[360px] ">
            <div className="flex flex-col gap-[20px] md:gap-[25px]">
              <div className=" selection:bg-emerald-600 flex md:space-x-1.5 text-2xl font-bold text-center text-neutral-600">
                <div className="hidden md:block w-10 h-10 md:w-12 md:h-12 [&_img]:w-full [&_img]:h-full">
                  <img
              ...
              <div className="flex flex-col gap-[15px]">
                ...
                <div className="relative">
                  ...
                  <button
                    type="button"
                    className="flex items-center justify-center h-7 px-2 py-1.5 gap-x-1 text-[13px] md:text-[15px] whitespace-nowrap font-medium font-geist border rounded-full transition-colors focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 absolute right-1 top-1 border-none bg-white"
                  >
            ...
            <div className="grid grid-cols-2 md:flex md:gap-[50px] gap-6 ">
              <div className="flex   w-full md:w-[240px] flex-col gap-[15px]">
                ...
                <div className="flex flex-col transition-colors gap-[10px]">
                  <span className="text-foreground/60 hover:text-foreground/80 transition-colors underline-offset-[3.5px] break-words font-medium focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground-800 font-geist text-sm md:text-base">
                    M-15, Phase 1, Badli Industrial Estate, Delhi - 110042
                  </span>
                </div>
              </div>
              ...
              <div className="flex flex-col gap-[15px]">
                ...
                <div className="flex flex-col transition-colors gap-[10px]">
                  ...
                  <Link
                    href={paths.bisMarkForeign}
                    className="text-foreground/60 hover:text-foreground/80 transition-colors underline-offset-[3.5px] break-words hover:underline font-medium focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground-800 font-geist text-sm md:text-base"
                  >
                    BIS Mark (Foreign)
                  </Link>
                  <Link
                    href={paths.crsRegistration}
                    className="text-foreground/60 hover:text-foreground/80 transition-colors underline-offset-[3.5px] break-words hover:underline font-medium focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground-800 font-geist text-sm md:text-base"
                  >
                    CRS Registration
                  </Link>
              ...
              <div className="flex flex-col gap-[15px]">
                ...
                <div className="flex flex-col transition-colors gap-[10px]">
                  ...
                  <Link
                    href={paths.bisQcoUpdates}
                    className="text-foreground/60 hover:text-foreground/80 transition-colors underline-offset-[3.5px] break-words hover:underline font-medium focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground-800 font-geist text-sm md:text-base"
                  >
                    BIS QCO UPDATES
                  </Link>
                  <Link
                    href={paths.ministryUpdates}
                    className="text-foreground/60 hover:text-foreground/80 transition-colors underline-offset-[3.5px] break-words hover:underline font-medium focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-foreground-800 font-geist text-sm md:text-base"
                  >
                    Ministry Updates
                  </Link>
            ...
            <div className="flex gap-3 flex-wrap items-center justify-center">
              ...
              >
                <svg
                  ...
                  strokeWidth="0"
                  viewBox="0 0 24 24"
                  className="h-5 w-6 md:h-6 md:w-8 text-[#2a5075] duration-200 hover:-translate-y-2 cursor-pointer"
                  height="1em"
                  width="1em"
                  xmlns="http://www.w3.org/2000/svg"
                >
