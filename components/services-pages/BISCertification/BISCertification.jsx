...
const BISCertificationImage =
  "/services-main-images/indian-bis-certification.webp";
...
const OverviewSection = () => (
  <div className="flex flex-col gap-5">
    ...
    <ServiceParagraph>
      ...
      the standard quality mark on their products. This standard mark showcases
      that their products comply with the required quality, safety and
      reliability standards as set by BIS.
    </ServiceParagraph>
    ...
    <ServiceParagraph>
      ...
      appliances, cement and steel products, package drinking water, electronics
      like mobile phones, LED lights, power banks, precious metal jewelry
      (through hallmarking) and many more. The manufacturers and importers of
      these mandatory products cannot legally sell or distribute goods in India
      without BIS recognition.
    </ServiceParagraph>
    ...
    <ServiceParagraph>
      ...
      it is a mark of trust that the product has been tested for quality,
...
const SchemesSection = () => (
  <div className="flex flex-col gap-5">
    ...
    <ServiceParagraph>
      ...
      certificate enhances the reputation of Indian manufacturers, enables them
      to participate in government contracts, and opens up a host of other
      business opportunities. Most importantly, the absence of BIS certification
      can have damaging repercussions, ranging from legal fines and product
      recall to a complete ban of sale in India. Therefore, BIS compliance is
      more than a legal requirement, it is a targeted strategy for expanding
    ...
    <ServiceParagraph>
      ...
      to enter the Indian Market. This scheme guarantees the safety, quality, and
      performance assurance of the products manufactured abroad complying with
      the required Indian standards. As per FMCS, foreign companies wishing to
      sell products in India must first acquire a Bureau of Indian Standards
    ...
    <ServiceParagraph>
      ...
      Representative (AIR), who is responsible for communication and coordination,
      as the first point of contact with the Bureau of Indian Standards (BIS)
      for the scheme. It includes the filing of an application, in depth
      compliance evaluation, and the assumption of all necessary obligations to
      achieve compliance within the deadlines. As a result of following the FMCS
      guidelines, foreign companies are able to enter the Indian market, as well
      as acquire goodwill with the customers. Any product with an ISI mark shows
      a high level of quality, safety, and reliability assurance in India.
    </ServiceParagraph>
    ...
    <ServiceParagraph>
      Schome X, or the Omnibus Technical Regulation, is another BIS certification
      Scheme designed by the Bureau of Indian Standards to help simplify the
      compliance procedures of industries in mechanical and electrical domains.
      Unlike the other certification schemes, Scheme X focuses on reducing
      documentation, assessments, and approvals while ensuring that products
      adhere to the Indian Standards. The products with the standard mark are of
      exceptional quality and safety and can be sold after undergoing type
      testing, factory inspections, and simple certification of mandatory
      requirements.
    </ServiceParagraph>
    ...
    <ServiceParagraph>
      ...
      and compliance to regulations which are streamlined through this simplified
    ...
    <ServiceParagraph>
      ...
      regulating IT and electronic products in India. It focuses on assessing the
      safety and quality of high-risk products like LED lights, mobile phones,
      laptops, power banks, and other consumer electronics against Indian
      Standards. CRS, in contrast to the ISI scheme, does not issue an ISI mark,
      but certified products, in compliance with the scheme, bear a CRS mark
      with a unique registration number. All electronics and IT products need
      to be tested in the BIS-recognized laboratories and formally registered with
      BIS CRS, used to ensure compliance before they can be sold or imported
      into India.
    </ServiceParagraph>
    ...
    <ServiceParagraph>
      ...
      jewellery market as a whole. This is also the case for smaller retailers
      as well as larger scale manufacturers.
    </ServiceParagraph>
    ...
    <ServiceParagraph>
      ...
      prominently with safety and quality parameters, the Eco Mark is awarded to
      goods which conform to Indian Standards and which show at least some
      reduced level of the adverse environmental impact during any one or more of
      the various stages of the life cycle of the goods. Eco Mark certification
    ...
    <ServiceParagraph>
      ...
      compliance with the law and creates a competitive advantage with protective
      consumers and sustainability-oriented businesses. Eco Mark helps for the
      industry to trust and adopt green practices and for the consumers to trust
      that the products they buy are safe and environmentally responsible. Eco
      Mark supports India&apos;s vision for enhanced quality protection with
      environmental protection under BIS.
    </ServiceParagraph>
    ...
    <ServiceParagraph>
      ...
      others. MSCS certifies the firm for the legal operations, consistency, and
      continuous improvement of the operations. Certified firms go through
...
const DocumentsSection = () => (
  <div className="flex flex-col gap-5">
    ...
    <SectionHeadingThree className="mt-2">
...
const sections = [
  ...
  { id: "schemes", label: "Schemes", section: <SchemesSection /> },
  ...
  { id: "air", label: "AIR", section: <AIRSection /> },
