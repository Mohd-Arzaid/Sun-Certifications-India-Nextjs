...
const ISIMarkOverviewImage =
  "/services-main-images/bis-certification-for-indian-manufacturers.webp";
...
const OverviewSection = () => (
  <>
    <SectionHeadingTwo as="h1">ISI Mark Certification Scheme</SectionHeadingTwo>

    <ServiceImage
      src={ISIMarkOverviewImage}
    ...
    <ServiceParagraph>
      ...
      benchmarks to the products sold in India. The ISI Mark Certification is one
      of the most reputable certificates awarded under BIS.
    </ServiceParagraph>
    ...
    <ServiceParagraph>
      ...
      to use the standard mark (ISI Mark) under Scheme I Schedule I of Bureau of
      Indian Standard. Products kept under the mandatory certification scheme
      can not be manufactured, imported or sold in the Indian market without ISI
      mark. The list of mandatory products can be accessed on the official BIS
      website.
    </ServiceParagraph>
    ...
    <ServiceParagraph>
      <strong>BIS Certification :</strong> The process of granting approval to a
      product after ensuring that it meets the required Indian Standards. It is
      the framework under which conformity assessments are administered.
    </ServiceParagraph>
    ...
    <ServiceParagraph>
      <strong>1. Quality Assurance:</strong> The ISI mark signifies it has passed
      rigorous tests and inspections, thus maintaining the established highest
      standards of quality. This, in turn, increases the dependability and
      reliability of the product while minimizing the chances of defects.
    </ServiceParagraph>
...
const RequirementSection = () => (
  <>
    ...
    <ServiceParagraph>
      ...
      procedures to approach the BIS certification process: Normal Procedure
...
const ConclusionSection = () => (
  <>
    ...
    <ServiceParagraph>
      ...
      any other products for sale, BIS ISI Certification ensures your products are
