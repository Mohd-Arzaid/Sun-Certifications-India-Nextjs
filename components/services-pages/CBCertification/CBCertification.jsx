...
const OverviewSection = () => (
  <>
    <SectionHeadingTwo>CB Marking Certification Overview</SectionHeadingTwo>

    <SectionHeadingThree as="h3">
      CB marking shows a product meets basic EU safety and quality standards.
    </SectionHeadingThree>

    <ServiceParagraph>
      Getting a certified product or safe product is a right and wish of every
      customer around the world. CB is kind of certification mark on the
      ...
      Economic Area have to mandatorily obtain CB marking certification.
      ...
      will tell you about the basic of CB Marking Certification, How to get CB
      marking Certification, and the kinds of the CB Marking Certification.
      The EEA is bundled with European Countries like Iceland, Liechtenstein,
      and Norway. It is also considered as the EEA single market. CB stands
      for the &quot;Conformite Europeenne.&quot; The literal meaning of the CB is the
      European Conformity but later it changed it to CB mark in 1993. The
      products which are exported to EEA by the other countries can also have
      the CB marking as the EEA standards is a sign of guarantee.
    </ServiceParagraph>
  </>
);
...
const ServicesSection = () => (
  <>
    <SectionHeadingTwo>
      Services Provided Under CB Mark Certification
    </SectionHeadingTwo>

    <SectionHeadingThree as="h3">
      CB marking ensures trusted, globally accepted product standards.
    </SectionHeadingThree>
...
const ClassificationSection = () => (
  <>
    <SectionHeadingTwo>CB Marking and ISO Certification Service</SectionHeadingTwo>

    <SectionHeadingThree as="h3">
      CB and ISO marks boost product trust and quality.
    </SectionHeadingThree>
...
const NecessitySection = () => (
  <>
    <SectionHeadingTwo>Why CB Rating is Required?</SectionHeadingTwo>

    <SectionHeadingThree as="h3">
      CB certificate proves product energy efficiency and boosts trust.
    </SectionHeadingThree>
...
const ComplianceSection = () => (
  <>
    ...
    <SectionHeadingThree as="h3" className="mt-2">
      Mandatory CB-Labeled Products
    </SectionHeadingThree>
...
const sections = [
  ...
  { id: "services", label: "Services", section: <ServicesSection /> },
  {
    id: "classification",
...
const CBCertification = () => (
  <ServicePageLayout
    breadcrumbLabel="CB Mark Certification"
    hero={hero}
    sections={sections}
    faqs={faqs}
  />
