      ...
      <div className="max-w-[84rem] w-full mx-auto">
        <div className="flex flex-col items-start">
          <div className="relative px-8 z-20">
            <div className="m-0">
              <div className="shadow-[0_5px_40px_-12px_rgba(0,0,0,0.3)] w-full max-w-[740px] h-auto [&_img]:w-full [&_img]:h-auto [&_img]:object-cover">
                <img
                  src={HeroImage}
      ...
      >
        <div className="flex justify-between flex-col items-center w-full m-auto pb-12">
          <div className="flex flex-col gap-8 mt-10 mb-16">
            <div>
              <div>
                <h1 className="text-4xl text-black font-geist font-bold text-left max-w-3xl break-words">
                  Sun Certifications India
                </h1>
              </div>
            </div>
            <div className="max-w-2xl">
              <p className="font-geist text-gray-600">
                ...
                kinds of Indian certifications like BIS certificate for Indian
                manufacturers, BIS certification for foreign/global
                manufacturers, BIS Scheme X certification, LMPC certificate,
                EPR certificate, WPC certificate, etc.
              </p>
            </div>
          ...
          <div className="m-0">
            <div className="w-80 h-auto drop-shadow-xl [&_img]:w-full [&_img]:h-auto">
              <img
                src={HeroImageMobile}
                alt="Sun Certifications India - Professional Certification Services for BIS, LMPC, EPR, and WPC"
                title="Sun Certifications India - Professional Certification Services for BIS, LMPC, EPR, and WPC"
