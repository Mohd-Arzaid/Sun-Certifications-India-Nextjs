...
const WhatsOurCustomersSaySection = () => {
  ...
  const getSpeed = () => {
    if (containerRef.current) {
      const totalWidth = testimonials.length * 450;
    ...
    <div className="bg-white pt-5  pb-8 ">
      <div className="max-w-[88rem] px-8 w-full mx-auto ">
        ...
        >
          <div
            ref={scrollerRef}
            className={`flex w-max gap-8 md:gap-6 pt-10 pb-12 hover:[animation-play-state:paused] ${
                ...
                >
                  ...
                  <div className="flex items-center gap-4 mb-6 pr-12">
                    {isDuplicate ? (
                      ...
                      <div className="w-12 h-12 rounded-full border-2 border-[#1A8781]/30 flex-shrink-0 overflow-hidden [&_img]:w-full [&_img]:h-full [&_img]:object-cover">
                        <img
