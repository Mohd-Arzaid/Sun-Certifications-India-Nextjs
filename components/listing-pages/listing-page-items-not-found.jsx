...
// Jab search/filter se koi card na mile — message + optional Contact/WhatsApp/Call
const ListingPageItemsNotFound = ({
  message,
  hint,
    ...
    <div className="col-span-2 text-center">
      <div className="max-w-2xl mx-auto">
        <div className="bg-white rounded-2xl p-4 sm:p-6 md:p-8 shadow-sm border-2 border-gray-400">
          <p className="text-gray-600 font-geist text-base sm:text-lg">{message}</p>
          <p className="text-gray-600 font-geist text-base sm:text-lg">{hint}</p>
...
export default ListingPageItemsNotFound;
