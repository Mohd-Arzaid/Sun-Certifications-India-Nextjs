...
const MinistryCard = ({ notification }) => {
  const { color, tagType, title, description, displayDate, link } =
    notification;
...
const Ministry_Updates = () => {
  ...
  const sorted = [...MINISTRY_UPDATES_LIST].sort(
...
export default Ministry_Updates;
