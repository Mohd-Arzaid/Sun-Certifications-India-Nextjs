...
const pageCopy = {
  breadcrumbLabel: "India No 1",
  title: "All India First Licenses",
  description:
...
const IndiaNo1Card = ({ color, title, description, slug, date }) => {
...
const All_India_First = () => {
  ...
  const filteredPages = useMemo(() => {
    if (!normalizedSearchQuery) return ALL_INDIA_FIRST_LIST;

    return ALL_INDIA_FIRST_LIST.filter(
      (page) =>
              ...
              <div className="col-span-2 text-center">
                <div className="max-w-2xl mx-auto">
                  <div className="bg-white rounded-2xl p-4 sm:p-6 md:p-8 shadow-sm border-2 border-gray-400">
                    ...
                    <p className="text-gray-600 font-geist text-base sm:text-lg">
                      Try searching with different keywords or browse all India
                      No 1 pages.
                    </p>
...
export default All_India_First;
